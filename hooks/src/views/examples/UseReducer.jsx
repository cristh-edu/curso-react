...
import {initialState, allReducer} from '../../store/config'
        ...
        <div className="UseReducer">
            ...
            <div className="center">
                {state.user ?
                    ...
                    : <span className="text">Usuário Offline</span>
                }
                <span className="text"> {state.number} </span>
                <div>
                    <button className="btn" onClick={() => numberAdd2(dispatch)} >+2</button>
                    <button className="btn" onClick={() => login(dispatch, 'Cristhian')} >Login</button>
